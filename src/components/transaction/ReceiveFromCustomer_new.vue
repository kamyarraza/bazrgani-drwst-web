        ...
        <q-card class="modal-card" style="width: 700px; max-width: 95vw; max-height: 90vh; overflow: hidden;">
                ...
                <div v-if="props.transactionData" class="payment-status-card q-mb-md">
                    ...
                    <div class="status-grid">
                        <div class="status-item">
                            ...
                            <span class="status-value total-amount">${{ formatCurrency(props.transactionData.total_price
                                || 0)
                                }}</span>
                        </div>
                        <div class="status-item">
                            <span class="status-label">{{ t('payment.receiveFromCustomer.paidAmount') }}:</span>
                            <span class="status-value paid-amount">${{ formatCurrency(props.transactionData.paid_price
                                || 0) }}</span>
                        </div>
                        <div class="status-item">
                        ...
                        <div class="exchange-rate-display">
                            <div class="rate-item">
                                ...
                                <q-btn flat dense round icon="refresh" @click="refreshExchangeRate"
                                    ...
                                    :title="t('payment.receiveFromCustomer.refreshRate')" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="payment-grid">
                            <div class="payment-item">
                                ...
                                <q-input v-model.number="form.iqd_price" type="number" min="0" step="250" outlined dense
                                    suffix="IQD" :placeholder="t('payment.receiveFromCustomer.enterIqdAmount')"
                            ...
                            <div class="payment-item">
                                ...
                                <q-input v-model.number="form.usd_price" type="number" min="0" step="0.01" outlined
                                    dense suffix="USD" :placeholder="t('payment.receiveFromCustomer.enterUsdAmount')"
                            ...
                            <div class="payment-item">
                                ...
                                <q-input v-model.number="form.iqd_return_amount" type="number" min="0" step="250" outlined
                                    dense suffix="IQD" :placeholder="t('payment.receiveFromCustomer.enterIqdReturn')"
                            ...
                            <div class="payment-item">
                                ...
                                <q-input v-model.number="form.usd_return_amount" type="number" min="0" step="0.01"
                                    outlined dense suffix="USD"
                                    :placeholder="t('payment.receiveFromCustomer.enterUsdReturn')"
                    ...
                    <div class="payment-summary-card" v-if="totalPaymentAmount > 0">
                        ...
                        <div class="summary-content">
                            <div class="summary-row">
                                ...
                                <span class="summary-value total-payment">${{ formatCurrency(totalPaymentAmount)
                                    }}</span>
                            </div>
            ...
            <q-card-actions class="modal-actions" style="flex-shrink: 0;">
                <q-btn :label="$t('payment.receiveFromCustomer.cancel')" flat color="grey-7" @click="close"
                    class="cancel-btn" />
                <q-btn :label="$t('payment.receiveFromCustomer.receivePayment')" color="green-6" unelevated
                    :loading="loading" @click="handleSubmit" class="submit-btn" />
            </q-card-actions>
        </q-card>
    </q-dialog>
</template>
...
const handleSubmit = async () => {
    ...
    try {
        ...
        await store.receiveFromCustomer(transactionId.toString(), paymentData);
