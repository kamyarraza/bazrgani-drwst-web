    ...
    <q-card-section>
      <div class="row items-center justify-between q-mb-md">
        ...
        <div class="header-actions">
          <q-btn flat round color="secondary" icon="refresh" size="sm" @click="refreshActivities" :loading="loading">
            <q-tooltip>{{ $t('dashboard.refreshActivities') }}</q-tooltip>
          </q-btn>
          <q-btn flat round color="secondary" icon="visibility" size="sm" @click="viewAllActivities">
      ...
      <div v-else class="activities-grid">
        <div v-for="(activity, index) in displayedActivities" :key="index" class="activity-card"
          :class="{ 'latest': index === 0 }">
          <div class="activity-header">
            <div class="activity-icon" :class="getActivityIconClass(activity.title)">
              <q-icon name="history" size="1.2rem" color="white" />
            </div>
            <div class="activity-time">
              <div class="time-ago">{{ activity.created_humans }}</div>
          ...
          <div class="activity-content">
            ...
            <div class="flex justify-between">
              ...
              <div class="activity-user">
                <q-icon name="computer" size="1.1rem" class="q-mr-xs" />
                <span>{{ activity.platform }}</span>
              </div>
              <div class="activity-user">
                <q-icon name="web" size="0.9rem" class="q-mr-xs" />
