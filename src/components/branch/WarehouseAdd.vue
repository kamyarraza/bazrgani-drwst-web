        ...
        <div class="q-pa-md">
          ...
          <div class="row q-col-gutter-md">
            ...
            <div class="col-12 col-md-6">
              ...
              <Qinput v-model="form.name" :label="t('warehouse.name', 'Warehouse Name')"
              ...
              <Qinput v-model="form.code" :label="t('warehouse.code', 'Warehouse Code')" outlined
                class="enhanced-input">
                <template #before>
            ...
            <div class="col-12 col-md-6">
              ...
              <Qinput v-model="form.address" :label="t('warehouse.address', 'Warehouse Address')"
                :rules="[val => !!val || t('validation.required', 'This field is required')]" outlined
                class="enhanced-input">
                <template #before>
              ...
              <Qinput v-model.number="form.capacity" :label="t('warehouse.capacity', 'Storage Capacity')" type="number"
                :rules="[
          ...
          <div class="row justify-end q-gutter-sm">
            <Qbtn :btn-label="t('common.cancel', 'Cancel')" color="negative" :is-flat="true" :no-caps="true"
              @click="model = false" />
            <Qbtn type="submit" :btn-label="t('warehouse.addBtn', 'Add Warehouse')" color="primary" :is-rounded="false"
              :no-caps="true" :loading="loading" />
          </div>
        </div>
      </q-form>
    </template>
