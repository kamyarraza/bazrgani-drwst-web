export default {
  ...
  item: {
    ...
    archive: "الأرشيف",
    archiveItem: "أرشفة العنصر",
    archiveWarning: "سيتم أرشفة هذا العنصر بشكل دائم",
    itemInformation: "معلومات العنصر",
    archiveWarnings: "تحذيرات الأرشفة",
    stockCheck: "التحقق من المخزون",
    noStockRemaining: "✓ لا يوجد مخزون متبقٍ - جاهز للأرشفة",
    stockStillRemaining: "⚠ ما زال هناك مخزون: {quantity} وحدة",
    archiveConsequences: "مهم - يرجى القراءة بعناية:",
    archiveWarning1: "سيتم أرشفة العنصر بشكل دائم",
    archiveWarning2: "سيتم الاحتفاظ بجميع سجلات المعاملات ولكن سيتم إخفاء العنصر",
    archiveWarning3: "لن يظهر العنصر في قوائم المنتجات أو عمليات البحث",
    confirmArchive: "تأكيد مطلوب",
    confirmArchiveText: "أنا أفهم العواقب وأرغب في أرشفة هذا العنصر",
    cannotArchiveWithStock: "لا يمكن أرشفة العنصر طالما أن المخزون ما زال موجودًا. يرجى تحويل أو بيع المخزون المتبقي أولاً.",
    archiveNow: "أرشفة العنصر",
    totalItems: "إجمالي المنتجات",
  ...
  branchReport: {
    title: "تقرير الفرع",
    subtitle: "تقرير عناصر المستودع للفرع المحدد",
    adminOnly: "يمكن للمديرين فقط عرض تقارير الفروع",
    totalItems: "إجمالي العناصر",
    totalQuantity: "إجمالي الكمية",
    totalValue: "إجمالي القيمة",
    totalUnitCostUSD: "إجمالي تكلفة الوحدة بالدولار",
    totalUnitCostIQD: "إجمالي تكلفة الوحدة بالدينار",
  ...
  customer: {
    ...
    hasAccount: "يملك حساب",
    noAccount: "لا يملك حساب",
    note: "ملاحظات",
    printDetails: "طباعة التفاصيل",
    printing: "جاري الطباعة...",
    printSuccess: "تم إرسال تفاصيل العميل للطابعة بنجاح",
    printFailed: "فشل في طباعة تفاصيل العميل",
    ...
    print: {
      ...
      documentTitle: "تقرير تفاصيل العميل",
      generatedOn: "تم إنشاؤه في",
      basicInformationTitle: "المعلومات الأساسية",
      creditInformationTitle: "معلومات الائتمان",
      ...
      supplierDebtDescription: "هذا هو المبلغ الذي ندين به لهذا المورد مقابل المشتريات",
      customerDebtDescription: "هذا هو المبلغ الذي يدين به هذا العميل لنا مقابل المشتريات",
      footerNote: "تم إنشاء هذا المستند تلقائياً بواسطة نظام ERP بازرگانی.",
      contactNote: "للأسئلة أو الاستفسارات، يرجى الاتصال بمسؤول النظام."
    },
